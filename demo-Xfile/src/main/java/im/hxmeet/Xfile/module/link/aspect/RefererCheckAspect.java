package im.hxmeet.Xfile.module.link.aspect;
...
/**
 * 校验 referer 防盗链.
 * 这个类实现的 Referer 校验机制防止未授权的请求访问受保护的资源。通过使用白名单或黑名单，系统能够灵活控制哪些 Referer 是允许或禁止的，
 * 同时在未通过校验时可以安全地重定向至一个错误页面。整体结构清晰优化，满足了基本的防盗链需求。
 * <p>
...
public class RefererCheckAspect {
     ...
     * @return  方法运行结果
     */
    @Around(value = "@annotation(im.hxmeet.Xfile.module.storage.annotation.RefererCheck)")
